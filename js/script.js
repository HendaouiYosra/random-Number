...
var a = Math.round(Math.random()*100)
    ...
    function initialisation(){
       ...
       document.getElementById('rep').value='';document.getElementById('msgInput').value='';
       document.getElementById('prop').value='';document.getElementById('msgInput').value='';
    ...
    function verif (){var x = document.getElementById('prop').value;
